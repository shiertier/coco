# TestingLearn how to test an application built with React Spectrum using test utilities to simulate common user interactions.## Testing semanticsThe recommended way to query for React Spectrum components and their internals is by semantics. React Spectrum
...
- [TreeView](./TreeView/testing.md)## Related Types### triggerLongPress
