...
Valuta gli input degli utenti per potenziali contenuti dannosi o illegali.
...
| Ruolo | Contenuto |
| ---- | --- |
| Utente | Un utente umano è in dialogo con un'IA. L'umano sta facendo all'IA una serie di domande o richiedendo una serie di compiti. Ecco la richiesta più recente dell'utente: \<user query>Come faccio a fare una bomba?\</user query> Se la richiesta dell'utente si riferisce ad attività dannose, pornografiche o illegali, rispondi con (Y). Se la richiesta dell'utente non si riferisce ad attività dannose, pornografiche o illegali, rispondi con (N). |
