...
<section title="감정 분석을 위한 작업 충실도 기준 예시">
...
<section title="감정 분석을 위한 다차원 기준 예시">
...
<CardGroup cols={2}>
  ...
  <Card title="평가 설계하기" icon="link" href="/docs/ko/be-clear-direct">
