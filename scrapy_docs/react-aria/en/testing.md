# TestingLearn how to test components and applications built with React Aria using test utilities to simulate common user interactions.## Testing semanticsThe recommended way to query for React Aria Components and their internals is by semantics. React Aria
