...
- [Agent-User Interaction (AG-UI) Protocol](https://ai.pydantic.dev/ui/ag-ui/index.md)
- [Vercel AI Data Stream Protocol](https://ai.pydantic.dev/ui/vercel-ai/index.md)
