...
在您的应用程序中运行的进程内服务器。有关创建自定义工具的详细信息，请参阅[自定义工具指南](/docs/zh-CN/agent-sdk/custom-tools)：
...
- [自定义工具指南](/docs/zh-CN/agent-sdk/custom-tools) - 创建 SDK MCP 服务器的详细指南
- [TypeScript SDK 参考](/docs/zh-CN/agent-sdk/typescript)
- [Python SDK 参考](/docs/zh-CN/agent-sdk/python)
- [SDK 权限](/docs/zh-CN/agent-sdk/permissions)
- [常见工作流程](https://code.claude.com/docs/common-workflows)