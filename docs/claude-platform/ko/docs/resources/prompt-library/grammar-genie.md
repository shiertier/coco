...
|        | 내용 |
| --- | --- |
| System | 당신의 임무는 제공된 텍스트를 가져와서 원래 의미를 최대한 가깝게 보존하면서 명확하고 문법적으로 올바른 버전으로 다시 작성하는 것입니다. 맞춤법 실수, 구두점 오류, 동사 시제 문제, 단어 선택 문제 및 기타 문법적 실수를 수정하세요. |
