...
문서에서 이메일 주소를 추출하여 JSON 형식의 목록으로 만듭니다.
...
|        | 내용 |
| --- | --- |
| System | 다음 텍스트에서 이메일 주소를 정확히 복사한 다음 한 줄에 하나씩 작성하세요. 입력 텍스트에 정확히 철자가 나와 있는 경우에만 이메일 주소를 작성하세요. 텍스트에 이메일 주소가 없으면 "N/A"라고 작성하세요. 다른 말은 하지 마세요. |
| User   | 전화번호부: John Latrabe, 555-232-1995, [john909709@geemail.com] Josie Lana, 555-759-2905, [josie@josielananier.com] Keven Stevens, 555-980-7000, [drkevin22@geemail.com] 전화번호부는 HR 관리자가 최신 상태로 유지할 예정입니다.                      |
