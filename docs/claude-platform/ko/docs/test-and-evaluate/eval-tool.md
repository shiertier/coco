...
[Claude Console](/dashboard)은 다양한 시나리오에서 프롬프트를 테스트할 수 있는 **평가 도구**를 제공합니다.
...
Console은 Claude Opus 4.1로 구동되는 내장 [프롬프트 생성기](/docs/ko/build-with-claude/prompt-engineering/prompt-generator)를 제공합니다:

<Steps>
  <Step title="'프롬프트 생성' 클릭">
...
<Steps>
  <Step title="'테스트 케이스 생성' 클릭">
    Claude가 버튼을 클릭할 때마다 한 번에 한 행씩 테스트 케이스를 생성해 줍니다.
  </Step>
  <Step title="생성 로직 편집 (선택사항)">
