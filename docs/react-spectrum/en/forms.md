...
<InlineAlert variant="informative">
  ...
  <Content>The default error messages are localized by the browser using the browser/operating system language setting. React Spectrums's [Provider](Provider.md) has no effect on validation errors.</Content>
</InlineAlert>
