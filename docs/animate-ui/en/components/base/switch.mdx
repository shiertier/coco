...
<ComponentPreview name="demo-components-base-switch" />

## Installation

<ComponentInstallation name="components-base-switch" />
...
<ExternalLink
  href="https://animate-ui.com/docs/primitives/base/switch#switch"
