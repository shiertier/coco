---
title: Primitives
description: Animated, unstyled components to let you express your creativity.
---

import { SparklesIcon, RectangleHorizontalIcon, TypeIcon } from 'lucide-react';
...
<Cards>
  <Card
    ...
    href="/docs/primitives/animate/avatar-group"
    title="Animate UI"
    accent
  />
  <Card
    ...
    href="/docs/primitives/radix/accordion"
    title="Radix UI"
    accent
  />
  <Card
    ...
    href="/docs/primitives/base/accordion"
    title="Base UI"
    accent
  />
  <Card
    ...
    href="/docs/primitives/headless/checkbox"
    title="Headless UI"
    accent
  />
  <Card
    icon={<SparklesIcon fill="currentColor" strokeWidth={1.5} />}
    href="/docs/primitives/effects/blur"
    title="Effects"
    accent
  />
  <Card
    icon={<RectangleHorizontalIcon fill="currentColor" strokeWidth={1.5} />}
    href="/docs/primitives/buttons/button"
    title="Buttons"
    accent
  />
  <Card
    icon={<TypeIcon strokeWidth={3} />}
    href="/docs/primitives/texts/counting-number"
    title="Texts"
    accent
  />
</Cards>
