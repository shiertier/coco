...
Voice Agents SDK 提供了用于 [OpenAI Realtime API](https://platform.openai.com/docs/guides/realtime) 的 TypeScript 客户端。

<LinkCard
  title="快速开始"
  href="/openai-agents-js/zh/guides/voice-agents/quickstart"
  description="几分钟内构建您的第一个实时语音助手，使用 OpenAI Agents SDK。"
/>
...
通过使用语音到语音模型，我们可以利用模型实时处理音频的能力，而无需在模型响应后先转录文本再将其转换回音频。
