...
) -> Optional[Union[ErrorResponse, IndexResponse]]:
    if response.status_code == 200:
        response_200 = IndexResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ErrorResponse, IndexResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[ErrorResponse, IndexResponse]
    """
